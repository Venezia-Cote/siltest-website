...
export const courses = [
  {
    ...
    level: "Intermediate",
    track: "analysis",
    nextDate: "30 Sep to 2 Oct",
    enrolment: {
      open: true,
      dateLabel: "30 September to 2 October 2026",
      dateShort: "30 Sep to 2 Oct 2026",
      startDateISO: "2026-09-30",
      endDateISO: "2026-10-02",
      delivery: "Online, live with the instructor",
      hours: "3 days, 3 hours a day",
      time: "14:00 to 17:00 CET",
      price: "499",
      currency: "EUR",
      priceNote: "per seat, excluding VAT",
      checkout: "https://buy.stripe.com/28E14nfm99va0gy5mNg7e05",
      includes: [
        "Three live sessions with the instructor, not a recording",
        "Hands-on labs in JMP and YieldOptiX using sample STDF data",
        "The SilTest Certified Yield Analyst credential on completion, after a short assessment",
      ],
    },
    num: "01",
    ...
    upcoming: true,
    glance: { duration: "3 days, 3 hours a day", format: "Theory plus guided labs", delivery: "Online, live with the instructor", language: "English" },
    audience: [
  ...
  },
  {
    ...
    level: "Foundation",
    track: "core",
    nextDate: "5 to 8 October",
    enrolment: {
      open: true,
      dateLabel: "5 to 8 October 2026",
      dateShort: "5 to 8 Oct 2026",
      startDateISO: "2026-10-05",
      endDateISO: "2026-10-08",
      delivery: "Online, live with the instructor",
      hours: "4 days, 3 hours a day",
      time: "14:00 to 17:00 CET",
      price: "699",
      currency: "EUR",
      priceNote: "per seat, excluding VAT",
      checkout: "https://buy.stripe.com/28E14ngqdcHm2oG8yZg7e00",
      includes: [
        "Four live sessions with the instructor, not a recording",
        "Structured theory backed by practical, real-world examples",
        "The Semiconductor Test Foundation certificate on completion, after a short assessment",
      ],
    },
    num: "02",
    ...
    upcoming: true,
    glance: { duration: "4 days, 3 hours a day", format: "Theory plus practical examples", delivery: "Online, live with the instructor", language: "English" },
    audience: [
  ...
  },
  {
    ...
    level: "Leadership",
    track: "leadership",
    nextDate: "28 + 29 September",
    enrolment: {
      open: true,
      dateLabel: "28 and 29 September 2026",
      dateShort: "28 + 29 Sep 2026",
      startDateISO: "2026-09-28",
      endDateISO: "2026-09-29",
      delivery: "Online, live with the instructor",
    ...
    faq: [
      { q: "Is this online or in person?", a: "The 28 and 29 September session runs online, live with the instructor, 14:00 to 18:00 CET on both days. For a private team session we can also come on-site." },
